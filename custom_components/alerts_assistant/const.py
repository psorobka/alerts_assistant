...
CONF_WATCH_TARGET = "target"
CONF_WATCH_LABELS = "labels"
CONF_ENTITY_DOMAIN = "entity_domain"
CONF_DEVICE_CLASS = "device_class"
CONF_LABEL_IDS = "label_ids"
CONF_MISSING_ENTITY_IDS = "missing_entity_ids"
CONF_MISSING_LABEL_IDS = "missing_label_ids"
RESOLVED_ENTITY_IDS = "_resolved_entity_ids"
CONF_ALERT_STATE = "state"
CONF_NUMERIC_COMPARATOR = "numeric_comparator"
